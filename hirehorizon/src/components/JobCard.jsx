...
export default function JobCard({ data }) {
    ...
    return (
        <div className="bg-blue-50 text-black dark:bg-white/75 p-3 rounded-lg w-5/6 lg:w-2/3 cursor-pointer mb-5 drop-shadow-md" onClick={handleClick}>
            {
                isClient &&
                ...
                <div className="flex flex-col md:flex-row items-start justify-start md:justify-between">
                    ...
                    <div className="flex flex-row md:flex-col gap-4 justify-between max-sm:items-center w-full lg:w-2/6">
